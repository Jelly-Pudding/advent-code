...
for i in range(len(cave[1])):
    cave[1][i] = "." * 10000 + cave[1][i] + "." * 10000

new_markers = "." * 10000 + "." * len(cave[1][0]) + "." * 10000
cave[1].append(new_markers)
floor_blocker = "#" * 10000 + "#" * len(cave[1][0]) + "#" * 10000
cave[1].append(floor_blocker)

simulated = simulate(cave[1])
