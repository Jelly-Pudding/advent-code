...
space_used = all_directories["/"][0]
unused_space = total_disk_space - space_used
update = 30000000
needed_for_update = 30000000 - unused_space
print(needed_for_update)

another_dictionary = {}

for key, value in all_directories.items():
    if value[0] >= needed_for_update:
        another_dictionary[key] = value[0]

print(another_dictionary)
smallest = min(another_dictionary, key=another_dictionary.get)
print(another_dictionary[smallest])